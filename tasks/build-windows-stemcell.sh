...
mv $PACKER_PLUGIN_PATH/acker-plugin-vsphere_v1.4.0_x5.0_linux_amd64 $PACKER_PLUGIN_PATH/github.com/hashicorp/vsphere/packer-plugin-vsphere_v1.4.0_x5.0_linux_amd64
OLD_PWD=$OLDPWD
