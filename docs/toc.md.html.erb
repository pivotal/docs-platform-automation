...
* [**How-to guides**](./how-to-guides/installing-opsman.md)
  ...
  * [Generating an Auth file](./how-to-guides/configuring-auth.md)
  * [Generating an Env file](./how-to-guides/configuring-env.md)
  * [Creating a director config file](./how-to-guides/creating-a-director-config-file.md)
  * [Extending a pipeline to install a product](./how-to-guides/adding-a-product.md)
