...
[externalized-tile-config]: {{ path }}pipeline-design/externalized-tile-config.md
...
[multi-foundation-secrets-handling]: {{ path }}pipeline-design/externalized-tile-config.md#multiple-foundations-using-secrets-handling
