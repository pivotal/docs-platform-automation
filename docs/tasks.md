...
=== "Task"
    ---excerpt--- "tasks/create-certificate-authority"
=== "Implementation"
    ---excerpt--- "tasks/create-certificate-authority-script"
<!-- === "Usage"
    ---excerpt--- "reference/create-certificate-authority-usage" -->
...
Generate a self-signed certificate authority on the Ops Manager.

Output is a file, `new-ca/guid`, containing the GUID of the newly created CA.

=== "Task"
    ---excerpt--- "tasks/generate-certificate-authority"
=== "Implementation"
    ---excerpt--- "tasks/generate-certificate-authority-script"
<!-- === "Usage"
    ---excerpt--- "reference/generate-certificate-authority-usage" -->
