...
??? info "CLI Versions"
    ...
    | aws-cli | 1.34.18 |
    | azure-cli | 2.64.0 |
    | bbr-cli | [1.9.68](https://github.com/cloudfoundry-incubator/bosh-backup-and-restore/releases/tag/v1.9.68) |
    ...
    The full Docker image-receipt: <a href="https://platform-automation-release-candidate.s3-us-west-2.amazonaws.com/image-receipt-5.2.2" target="_blank">Download</a>
