...
### What's New
* Documentation engine has been changed to mkdocs. Please give us feedback on the [new documentation](https://docs.pivotal.io/pcf-automation/v1.1/index.html)!
...
* `public_ssh_key` is now a configurable key for [vsphere](https://docs.pivotal.io/pcf-automation/v1.1/reference/inputs-outputs.html#vsphere)
...
* `import-installation` no longer takes an `auth.yml`, which used to contain `decryption-passphrase`.
  ...
  [env file](https://docs.pivotal.io/pcf-automationhttps://docs.pivotal.io/pcf-automation/pcf-automation/v1.1/reference/inputs-outputs.html#env/v1.1/reference/inputs-outputs.html#env)
