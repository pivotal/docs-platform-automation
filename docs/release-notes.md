...
* `public_ssh_key` is now a configurable key for [vsphere](https://docs.pivotal.io/pcf-automation/pcf-automation/v1.0/task-reference.html#public_ssh_key)
...
* `import-installation` no longer takes an `auth.yml`, which used to contain `decryption-passphrase`.
  ...
  [env file](https://docs.pivotal.io/pcf-automation/pcf-automation/v1.0/task-reference.html#env)
